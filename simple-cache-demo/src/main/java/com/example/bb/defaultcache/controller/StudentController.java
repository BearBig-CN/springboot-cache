package com.example.bb.defaultcache.controller;

import com.example.bb.defaultcache.dao.StudentDAO;
...
public class StudentController {
    ...
    public Student obtainOne(@PathVariable Integer id) {
    ...
    public Student update(@PathVariable Integer id, @PathVariable String name) {
        return studentDAO.updateByPrimaryKey(id, name);
    }
}
